...
export default function Documentation() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="fixed top-0 left-0 right-0 z-[60] bg-background/80 backdrop-blur-sm border-b border-foreground/20 p-4 flex justify-between items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 documentation-content">
